...
namespace RASAMOTORS.Inventory {
    ...
    public partial class InventoryData : global::System.Data.DataSet {
        ...
        public partial class inventoryDataTable : global::System.Data.TypedTableBase<inventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public inventoryRow AddinventoryRow(string itemName, string itemType, float buyingPrice, float sellingPrice, int availableQty, int soldQty, System.DateTime addedDate, string supplier) {
...
namespace RASAMOTORS.Inventory.InventoryDataTableAdapters {
    ...
    public partial class inventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [inventory] ([itemName], [itemType], [buyingPrice], [sellingPrice], [availableQty], [soldQty], [addedDate], [supplier]) VALUES (@itemName, @itemType, @buyingPrice, @sellingPrice, @availableQty, @soldQty, @addedDate, @supplier);
SELECT itemID, itemName, itemType, buyingPrice, sellingPrice, availableQty, soldQty, addedDate, supplier FROM inventory WHERE (itemID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [inventory] SET [itemName] = @itemName, [itemType] = @itemType, [buyingPrice] = @buyingPrice, [sellingPrice] = @sellingPrice, [availableQty] = @availableQty, [soldQty] = @soldQty, [addedDate] = @addedDate, [supplier] = @supplier WHERE (([itemID] = @Original_itemID) AND ((@IsNull_itemName = 1 AND [itemName] IS NULL) OR ([itemName] = @Original_itemName)) AND ((@IsNull_itemType = 1 AND [itemType] IS NULL) OR ([itemType] = @Original_itemType)) AND ((@IsNull_buyingPrice = 1 AND [buyingPrice] IS NULL) OR ([buyingPrice] = @Original_buyingPrice)) AND ((@IsNull_sellingPrice = 1 AND [sellingPrice] IS NULL) OR ([sellingPrice] = @Original_sellingPrice)) AND ((@IsNull_availableQty = 1 AND [availableQty] IS NULL) OR ([availableQty] = @Original_availableQty)) AND ((@IsNull_soldQty = 1 AND [soldQty] IS NULL) OR ([soldQty] = @Original_soldQty)) AND ((@IsNull_addedDate = 1 AND [addedDate] IS NULL) OR ([addedDate] = @Original_addedDate)) AND ((@IsNull_supplier = 1 AND [supplier] IS NULL) OR ([supplier] = @Original_supplier)));
SELECT itemID, itemName, itemType, buyingPrice, sellingPrice, availableQty, soldQty, addedDate, supplier FROM inventory WHERE (itemID = @itemID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        itemID, itemName, itemType, buyingPrice, sellingPrice, availableQty" +
                ", soldQty, addedDate, supplier\r\nFROM            inventory Where addedDate betwee" +
                "n @From AND @To";
        ...
        public virtual int Delete(int Original_itemID, string Original_itemName, string Original_itemType, global::System.Nullable<float> Original_buyingPrice, global::System.Nullable<float> Original_sellingPrice, global::System.Nullable<int> Original_availableQty, global::System.Nullable<int> Original_soldQty, global::System.Nullable<global::System.DateTime> Original_addedDate, string Original_supplier) {
        ...
        public virtual int Insert(string itemName, string itemType, global::System.Nullable<float> buyingPrice, global::System.Nullable<float> sellingPrice, global::System.Nullable<int> availableQty, global::System.Nullable<int> soldQty, global::System.Nullable<global::System.DateTime> addedDate, string supplier) {
            if ((itemName == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_buyingPrice.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((float)(Original_buyingPrice.Value));
            }
            else {
            ...
            if ((Original_sellingPrice.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((float)(Original_sellingPrice.Value));
            }
            else {
            ...
            if ((Original_soldQty.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((int)(Original_soldQty.Value));
            }
            else {
            ...
            if ((Original_addedDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((System.DateTime)(Original_addedDate.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_addedDate, 
                    string Original_supplier) {
            return this.Update(itemName, itemType, buyingPrice, sellingPrice, availableQty, soldQty, addedDate, supplier, Original_itemID, Original_itemName, Original_itemType, Original_buyingPrice, Original_sellingPrice, Original_availableQty, Original_soldQty, Original_addedDate, Original_supplier, Original_itemID);
        }
    }
